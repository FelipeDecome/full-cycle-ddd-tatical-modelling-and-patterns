...
describe("Order repository test", () => {
  ...
  it("Should be able to create an order", async () => {
    ...
    const orderItem = new OrderItem("order-item-1", product.id, product.name, product.price, 10);
  ...
  it("Should be able to update an order", async () => {
    ...
    const orderItem2 = new OrderItem("order-item-2", product2.id, product2.name, product2.price, 5);
  ...
  it("Should be able to find all orders", async () => {
    ...
    const orderItem2 = new OrderItem("order-item-2", product2.id, product2.name, product2.price, 10);
